--[[
Coronium module for Corona SDK v1.85
...
---------------------------------------------------------------------  
function Coronium:uploadFile( fileMetaTable, _callback )
...
function Coronium:newFileParams( contentType )
  ...
  --if contentType == self.TEXT then
    --requestParams.bodyType = "text"
  --else
...
function Coronium:init( o )
  ...
  self.endpoint = "http://" .. self.appId .. "/1/"
end
